...
let Cancha = (() => {
    let _classDecorators = [(0, graphql_1.ObjectType)(), (0, typeorm_1.Entity)({ name: 'canchas' })];
    ...
    (() => {
        ...
        _descripcion_decorators = [(0, typeorm_1.Column)(), (0, graphql_1.Field)(() => String)];
        _estado_decorators = [(0, typeorm_1.Column)({ default: 'Activo' }), (0, graphql_1.Field)(() => String)];
        _separaciones_decorators = [(0, typeorm_1.OneToMany)(() => separacion_cancha_entity_1.SeparacionCancha, separacionCancha => separacionCancha.cancha, { cascade: true }), (0, graphql_1.Field)(() => [separacion_cancha_entity_1.SeparacionCancha], { nullable: true })];
