...
exports.UpdateCanchaInput = void 0;
const graphql_1 = require("@nestjs/graphql");
const class_validator_1 = require("class-validator");
const create_cancha_input_1 = require("./create-cancha.input");
let UpdateCanchaInput = (() => {
    let _classDecorators = [(0, graphql_1.InputType)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = (0, graphql_1.PartialType)(create_cancha_input_1.CreateCanchaInput);
    let _id_decorators;
    ...
    var UpdateCanchaInput = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_classThis, "UpdateCanchaInput");
    (() => {
        var _a;
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _id_decorators = [(0, graphql_1.Field)(() => graphql_1.ID)];
        _descripcion_decorators = [(0, graphql_1.Field)(() => String, { nullable: true }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
        ...
        UpdateCanchaInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UpdateCanchaInput = _classThis;
})();
exports.UpdateCanchaInput = UpdateCanchaInput;
