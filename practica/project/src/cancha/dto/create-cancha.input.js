...
exports.CreateCanchaInput = void 0;
const graphql_1 = require("@nestjs/graphql");
const class_validator_1 = require("class-validator");
let CreateCanchaInput = (() => {
    ...
    var CreateCanchaInput = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "CreateCanchaInput");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _descripcion_decorators = [(0, graphql_1.Field)(() => String), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.IsString)()];
        ...
        CreateCanchaInput = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CreateCanchaInput = _classThis;
})();
exports.CreateCanchaInput = CreateCanchaInput;
