...
const separacion_cancha_entity_1 = require("src/separacion-cancha/entities/separacion-cancha.entity");
let Deportista = (() => {
    let _classDecorators = [(0, graphql_1.ObjectType)(), (0, typeorm_1.Entity)({ name: 'deportistas' })];
    ...
    let _separaciones_decorators;
    let _separaciones_initializers = [];
    let _separaciones_extraInitializers = [];
    var Deportista = _classThis = class {
        constructor() {
            ...
            this.separaciones = (__runInitializers(this, _estado_extraInitializers), __runInitializers(this, _separaciones_initializers, void 0));
            __runInitializers(this, _separaciones_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "Deportista");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)('increment'), (0, graphql_1.Field)(() => graphql_1.ID)];
        _nombre_decorators = [(0, typeorm_1.Column)(), (0, graphql_1.Field)(() => String)];
        _identificacion_decorators = [(0, typeorm_1.Column)(), (0, graphql_1.Field)(() => String)];
        _equipo_decorators = [(0, typeorm_1.Column)(), (0, graphql_1.Field)(() => String)];
        _estado_decorators = [(0, typeorm_1.Column)({ default: 'Activo' }), (0, graphql_1.Field)(() => String)];
        _separaciones_decorators = [(0, typeorm_1.OneToMany)(() => separacion_cancha_entity_1.SeparacionCancha, separacionCancha => separacionCancha.deportista, { cascade: true }), (0, graphql_1.Field)(() => [separacion_cancha_entity_1.SeparacionCancha], { nullable: true })];
        ...
        __esDecorate(null, null, _separaciones_decorators, { kind: "field", name: "separaciones", static: false, private: false, access: { has: obj => "separaciones" in obj, get: obj => obj.separaciones, set: (obj, value) => { obj.separaciones = value; } }, metadata: _metadata }, _separaciones_initializers, _separaciones_extraInitializers);
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        Deportista = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Deportista = _classThis;
})();
