...
const separacion_cancha_module_1 = require("./separacion-cancha/separacion-cancha.module");
let AppModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            imports: [
                ...
                deportista_module_1.DeportistaModule,
                separacion_cancha_module_1.SeparacionCanchaModule,
            ],
            controllers: [],
            providers: [],
        })];
